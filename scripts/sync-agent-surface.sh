...
FILES=(
  ...
  "memory-cockpit-v2/scripts/write-dogfood-pin.mjs"
  "memory-cockpit-v2/scripts/dogfood-fixture-test.mjs"
  ...
  "memory-cockpit-v2/scripts/reports-inflight-ui-test.mjs"
  ...
  "memory-cockpit-v2/server/filingMapCloseout.js"
  "memory-cockpit-v2/server/researchRunCloseout.js"
  "memory-cockpit-v2/scripts/filing-map-test.mjs"
  "memory-cockpit-v2/scripts/filing-map-closeout-test.mjs"
  ...
  "memory-cockpit-v2/server/learnSchema.js"
  "memory-cockpit-v2/server/thinLearn.js"
  "memory-cockpit-v2/server/learnAgentSeed.js"
  "memory-cockpit-v2/server/learnMap.js"
  "memory-cockpit-v2/server/learnHarvest.js"
  "memory-cockpit-v2/server/learnDiagrams.js"
  "memory-cockpit-v2/server/learnPhotos.js"
  "memory-cockpit-v2/server/learnDeep.js"
  "memory-cockpit-v2/index.html"
  "memory-cockpit-v2/public/manifest.webmanifest"
  "memory-cockpit-v2/public/apple-touch-icon.png"
  "memory-cockpit-v2/public/icon-192.png"
  "memory-cockpit-v2/public/icon-512.png"
  "memory-cockpit-v2/src/pages/thin/Background.jsx"
  "memory-cockpit-v2/src/pages/thin/LearnDiagrams.jsx"
  "memory-cockpit-v2/src/pages/thin/LearnPhotos.jsx"
  "memory-cockpit-v2/src/pages/thin/learnDiagramLayout.js"
  "memory-cockpit-v2/src/pages/thin/learnDiagramPick.js"
  "memory-cockpit-v2/scripts/thin-learn-test.mjs"
  "memory-cockpit-v2/scripts/learn-factory.mjs"
  "memory-cockpit-v2/scripts/learn-photos.mjs"
  "memory-cockpit-v2/scripts/fixtures/learn-product-map.json"
  "memory-cockpit-v2/plans/LEARN-PHOTOS-PLAN.md"
  "memory-cockpit-v2/plans/LEARN-ENGINE.md"
  "memory-cockpit-v2/plans/LEARN-DIAGRAMS-V2-PLAN.md"
  "memory-cockpit-v2/plans/LEARN-BACKGROUND-V3.md"
  ".grok/skills/company-learn/SKILL.md"
  ".grok/commands/cockpit-learn.md"
  "scripts/lab-feature-hooks/95-company-learn.sh"
  ...
  "memory-cockpit-v2/scripts/house-utterance-test.mjs"
  "memory-cockpit-v2/scripts/memory-sweep-test.mjs"
  "memory-cockpit-v2/scripts/risks-restore-test.mjs"
  "memory-cockpit-v2/scripts/mcp-risks-restore-test.mjs"
  "memory-cockpit-v2/scripts/go-commit.mjs"
  "memory-cockpit-v2/scripts/go-commit-test.mjs"
  "memory-cockpit-v2/scripts/house-closeout.mjs"
  "memory-cockpit-v2/scripts/house-closeout-test.mjs"
  "memory-cockpit-v2/scripts/register-closeout.mjs"
  "memory-cockpit-v2/scripts/register-closeout-test.mjs"
  "memory-cockpit-v2/scripts/new-desk-closeout.mjs"
  "memory-cockpit-v2/scripts/new-desk-closeout-test.mjs"
  "memory-cockpit-v2/scripts/house-propose-guard-test.mjs"
  "memory-cockpit-v2/scripts/house-stance-test.mjs"
  "memory-cockpit-v2/scripts/risk-sor-summary-test.mjs"
  "memory-cockpit-v2/scripts/dogfood-seed-desks.mjs"
  "memory-cockpit-v2/scripts/dogfood-seed-desks-test.mjs"
  ...
  "memory-cockpit-v2/src/pages/thin/Drivers.jsx"
  "memory-cockpit-v2/src/pages/thin/Driver.jsx"
  "memory-cockpit-v2/server/driverProposals.js"
  "memory-cockpit-v2/server/metricKind.js"
  "memory-cockpit-v2/scripts/drivers-closeout.mjs"
  "memory-cockpit-v2/scripts/drivers-closeout-test.mjs"
  "memory-cockpit-v2/scripts/drivers-compile-test.mjs"
  "memory-cockpit-v2/scripts/drivers-go-commit-test.mjs"
  "memory-cockpit-v2/scripts/drivers-log-test.mjs"
  "memory-cockpit-v2/scripts/drivers-room-test.mjs"
  "memory-cockpit-v2/scripts/desk-engine-order-test.mjs"
  "memory-cockpit-v2/scripts/metrics-proto-test.mjs"
  "memory-cockpit-v2/scripts/mcp-metrics-failclosed-test.mjs"
  "ontology/compile/from_nebius_drivers.py"
  "ontology/compile/from_nebius_risks.py"
  "ontology/compile/run.py"
  "scripts/scaffold-new-desk.sh"
  "memory-cockpit-v2/src/metricCopy.js"
  ...
  "memory-cockpit-v2/src/pages/thin/filingMapPaint.js"
  "memory-cockpit-v2/src/pages/thin/FilingMapDossier.jsx"
  "memory-cockpit-v2/src/pages/thin/Filings.jsx"
  "memory-cockpit-v2/server/contextpack.js"
  "memory-cockpit-v2/scripts/contextpack-test.mjs"
  "ontology/schema/contextpack_metrics.json"
  "ontology/api/contextpack.py"
