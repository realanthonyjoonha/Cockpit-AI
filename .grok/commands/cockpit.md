...
| `/cockpit-dogfood-e2e` | **Testing-cockpit dogfood** — MCP-isolated seal, fixture desk DOGF |
...
| `/cockpit-learn [desk] [primer\|tutor]` | **Background + tutor** — product/tech primer on glass; Grok remembers this desk |
| `/cockpit-report [desk] [mode]` | **Thesis lane** — checkpointed report + PDF (`ib-report` skill). Not daybook, not coverage |
| `/cockpit-filing-map [desk] [run_id]` | **Filing map** — SEC accession → house / register (Overview MAP FILINGS; on demand) |
