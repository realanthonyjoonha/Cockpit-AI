// msftModel.js — thin wrapper (Path 2A S3). Logic in thinModel.js.
// Microsoft desk payloads from compiled ontology pack (+ vault house view).
// Decision-support only.
import { createThinModel, MSFT_MODEL_PROFILE } from './thinModel.js';

const m = createThinModel(MSFT_MODEL_PROFILE);
