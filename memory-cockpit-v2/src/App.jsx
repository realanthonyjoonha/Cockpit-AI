...
function activeThinRoom(hash, slug) {
  ...
  if (hash.startsWith(`#/${slug}/reports`)) return `#/${slug}/reports`;
  if (hash.startsWith(`#/${slug}/filings`)) return `#/${slug}/filings`;
  if (hash.startsWith(`#/${slug}/background`) || hash.startsWith(`#/${slug}/learn`)) return `#/${slug}/background`;
