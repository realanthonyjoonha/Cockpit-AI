...
const FALLBACK_ALL = [
  ...
  { action: 'background', label: 'Background', hint: 'Product spine + HTML architecture · Background room', needs_desk: true, variants: ['desk'] },
  { action: 'tutor', label: 'Company tutor', hint: 'Personalized teach in Grok · remembers this desk', needs_desk: true, variants: ['desk'] },
  { action: 'comps', label: 'Comps', hint: 'Peers you supply + pack subject · optional save', needs_desk: true, variants: ['desk'] },
  { action: 'model-desk', label: 'Model desk', hint: 'Working assumptions + bridge vault · not PT · glass Model room', needs_desk: true, variants: ['desk'] },
  { action: 'model-read', label: 'Model read', hint: 'Explain Model numbers → taught PDF · Model room', needs_desk: true, variants: ['desk'] },
  ...
  { action: 'thesis-report', label: 'Thesis report', hint: 'Checkpointed IB note + PDF · Reports room', needs_desk: true, variants: ['desk'] },
